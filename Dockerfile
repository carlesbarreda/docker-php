...
#docker build -t carlesbarreda/php:8.0.3-fpm-alpine -f Dockerfile.php8.0-fpm.buildx .
#docker run -ti --rm --name php8.0-fpm-dev carlesbarreda/php:8.0.3-fpm-alpine /bin/sh
